...
CAMLprim value
caml_SDL_Mix_Init(value flags_list)
{
    Uint32 flags = 0;
...
CAMLprim value
caml_SDL_Mix_Open_Audio(value frequency, value format, value channels, value chunksize) 
{
...
CAMLprim value
caml_SDL_Mix_Load_Music(value filename)
{
...
CAMLprim value
caml_SDL_Mix_Free_Music(value music)
{
...
CAMLprim value
caml_SDL_Mix_Play_Music(value music, value loops)
{
...
CAMLprim value
caml_SDL_Mix_Get_Major_Version(value unit)
{
    return Val_int(SDL_MIXER_MAJOR_VERSION);
}

CAMLprim value
caml_SDL_Mix_Get_Minor_Version(value unit)
{
    return Val_int(SDL_MIXER_MINOR_VERSION);
}

CAMLprim value
caml_SDL_Mix_Get_Patchlevel(value unit)
{
    return Val_int(SDL_MIXER_PATCHLEVEL);
}

CAMLprim value
caml_SDL_Mix_Get_Channels(value unit)
{
    return Val_int(MIX_CHANNELS);
}

CAMLprim value
caml_SDL_Mix_Get_Default_Frequency(value unit)
{
    return Val_int(MIX_DEFAULT_FREQUENCY);
}

CAMLprim value
caml_SDL_Mix_Get_Default_Format(value unit)
{
    return Val_SDL_AudioFormat(MIX_DEFAULT_FORMAT);
}

CAMLprim value
caml_SDL_Mix_Get_Default_Channels(value unit)
{
    return Val_int(MIX_DEFAULT_CHANNELS);
}

CAMLprim value
caml_SDL_Mix_Get_Max_Volume(value unit)
{
    return Val_int(MIX_MAX_VOLUME);
}

CAMLprim value
caml_SDL_Mix_Get_Channel_Post(value unit)
{
    return Val_int(MIX_CHANNEL_POST);
}

CAMLprim value
caml_SDL_Mix_Get_Effectsmaxspeed(value unit)
{
